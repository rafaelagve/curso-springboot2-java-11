...
import com.rafael.course.entities.Payment;
...
import com.rafael.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// aplica a relação entre Product e Category
		...
		// salva os produtos com as associações
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
